...
HD_PWD='/home/chanon/comArchProj/MIPS-single-cycle-RTL-design/mips_proj/mips_proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mips_core.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mips_core.tcl -notrace
