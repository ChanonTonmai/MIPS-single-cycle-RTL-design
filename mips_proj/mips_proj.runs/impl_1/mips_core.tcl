...
namespace eval ::optrace {
  variable script "/home/chanon/comArchProj/MIPS-single-cycle-RTL-design/mips_proj/mips_proj.runs/impl_1/mips_core.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet /home/chanon/comArchProj/MIPS-single-cycle-RTL-design/mips_proj/mips_proj.runs/synth_1/mips_core.dcp
...
OPTRACE "link_design" START { }
  link_design -top mips_core -part xc7z020clg484-1 -mode out_of_context
...
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mips_core_opt.dcp
...
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mips_core_placed.dcp
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mips_core_physopt.dcp
...
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force mips_core_routed.dcp
...
if {$rc} {
  write_checkpoint -force mips_core_routed_error.dcp
