...
synth_design -top mips_core -part xc7z020clg484-1 -mode out_of_context
...
write_checkpoint -force -noxdef mips_core.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file mips_core_utilization_synth.rpt -pb mips_core_utilization_synth.pb"
