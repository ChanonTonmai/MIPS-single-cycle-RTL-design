...
HD_PWD='/home/chanon/comArchProj/MIPS-single-cycle-RTL-design/mips_proj/mips_proj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mips_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mips_core.tcl
